module.exports= {
    Bot: {
        ...
        prefix: "$getGuildVar[prefix]", //si pas de variable, mettez simplement le préfixe entre "", vous pouvez aussi mettre <@!$clientID> pour que le ping de votre bot soit un prefixe
